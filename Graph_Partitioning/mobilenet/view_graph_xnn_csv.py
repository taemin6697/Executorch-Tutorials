...
# 3. Partitioner를 사용하여 백엔드 할당 정보 파악 (낱개 연산 분석)
print("Analyzing Backend Partitioning for ALL nodes...")
...
csv_file = "full_backend_assignment.csv"
print(f"Generating FULL CSV: {csv_file}")
...
print(f"Success! FULL report saved to: {os.path.abspath(csv_file)}")
